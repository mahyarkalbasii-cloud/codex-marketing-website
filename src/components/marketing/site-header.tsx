    ...
    <header dir={direction} className="site-header sticky top-0 z-[60] border-b border-[#e4d8c8]/80 bg-[#fbf6ed]/96 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/92">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between pl-4 pr-5 md:h-[68px] md:px-6">
        <Link href={localizeHref("/", locale)} className="flex items-center gap-3">
          <span className="site-brand-mark flex h-9 w-9 items-center justify-center rounded-2xl bg-[#2a241d] text-[#fffaf1] shadow-sm shadow-[#2a241d]/10 dark:bg-white dark:text-zinc-950">
        ...
        <div className="flex items-center gap-2 min-[1120px]:hidden">
          ...
          <a
            href="tel:+982175425000"
            dir="ltr"
            className="hidden rounded-2xl border border-[#e4d8c8] bg-white/76 px-3 py-2 text-xs font-semibold text-[#4b4036] shadow-sm shadow-[#2a241d]/[0.04] min-[430px]:inline-flex dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300"
          >
            {site.phones[0]}
          </a>
          <MobileMenu />
