  ...
  },
  {
    ...
    "subcategories": [
      ...
      },
      {
        ...
        "strategicAdvice": "عامل کلیدی: پوشش کامل کلوزهای بیمه‌ای (جانی و مالی)، سقف تعهدات، سرعت در پرداخت خسارت، تخفیف‌های گروهی. توصیه استراتژیک: بیمه مسئولیت مدنی کارفرما در قبال کارکنان و اشخاص ثالث باید پیش از شروع خاک‌برداری فعال باشد. بیمه تضمین کیفیت (عیوب پنهان ۱۰ ساله) نیز برای پروژه‌های لوکس به عنوان آپشن فروش واحدها پرزنت شود."
      },
      {
        "id": 1146,
